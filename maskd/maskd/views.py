...
def log_to_dict(name='/home/richul/Documents/MASK-D/maskdweb/maskd/maskd/failed-login.log'):
    a=[]
...
def encode(dff):
    reader = geoip2.database.Reader('/home/richul/Documents/EnhancingMailServerSecurity/maskd/maskd/geolite2/GeoLite2-City_20200107/GeoLite2-City.mmdb')
...
def output(request):
    dff=log_to_dict('./media/aa.txt')
    dff2,dff=encode(dff)
    out=pyodtry(dff2,dff)
